...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        The Socket class constructor takes two parameters: the server address and the server port.
        The try-with-resources statement ensures that the socket is closed when it is no longer needed.** */

        try (Socket socket = new Socket(sever, port)) {
        ...
        /* **Catch any IOException that may occur and print the stack trace.
            An IOException is thrown when an input-output operation is failed or interrupted.** */
                ...
                LOGGER.config(exception.getLocalizedMessage());
            }
